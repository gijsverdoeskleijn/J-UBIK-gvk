...
- classification: this note is for Torsten, Jakob for circulation inside their UBIK/IFT group and Gijs Verdoes Kleijn and Eduardo Balbinot for circulation inside their OmegaCEN group. It contains links to proprietary code repositories and documents that might currently not be accessible to some of them. These can be made available upon request to either Gijs Verdoes Kleijn or Jakob.
    
This sheet describes one application idea the OmegaCEN Astronomical Science Data Center could be excited to pursue in a collaborative project with the [Information Field Theory Group / UBIK](https://wwwmpa.mpa-garching.mpg.de/~ensslin/) team at MPA and the [Data Science group at German Centre for Astrophysics](https://www.deutscheszentrumastrophysik.de/en). The response is informal and bullet-point based, and does not yet answer every prompt in equal detail. We answer selectively and focus on the points that are most helpful for understanding the idea. The OmegaCEN team is happy to discuss the application with the UBIK team to advance shaping the collaborative project.

## Application Snapshot
- Euclid ground- and space-based imagiging inference with [J-UBIK](https://github.com/NIFTy-PPL/J-UBIK)
- Optical and near-infrared imaging, RUBIN, DECam, CFHT, HSC, Pan-STARRS, Euclid VIS & NIR
- Application description: Euclid ground-based and space-based data processing innovation optimized for astrometry, EXT QA contribution. perhaps via ground-based imaging inference guided by Euclid high-resolution data.

## Current Research Context
- OmegaCEN's current research in this area is photometric and astrometric improvement of Euclid's ground-based imaging. The next milestone is the release (ETA December 2026) of the improved data processing algorithms and pipeline for Euclid's Data Release 2. An overview of the current algorithms and pipeline can be found in [EXT DR1 draft paper, Corcho-Caballero et al 2026 in prep](https://drive.google.com/file/d/13EXRfZlXxP1qMA5Dl5X8KPFtSjKcwCFR/view?usp=sharing)
